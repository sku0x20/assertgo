...
func Test_EqualMatcher_Match_Pass(t *testing.T) {
	m := matcher.NewEqualMatcher("hello", &testcomparator.MockComparator[string]{Result: 0})
	if !m.Match("hello") {
...
func Test_EqualMatcher_Match_Fail(t *testing.T) {
	m := matcher.NewEqualMatcher("hello", &testcomparator.MockComparator[string]{Result: -1})
	if m.Match("world") {
...
func Test_EqualMatcher_FailureMsg(t *testing.T) {
	m := matcher.NewEqualMatcher("hello", &testcomparator.MockComparator[string]{})
